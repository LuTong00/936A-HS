#ifndef ABSTRACT_MOTOR_GROUP_HPP
#define ABSTRACT_MOTOR_GROUP_HPP

#include <vex.h>
#include <vector>

/**
 * @brief The AbstractMotorGroup class implements a motor group, but data are taken from all motors
   and returned as a vector.
*/
class AbstractMotorGroup {
    /**
...
public:
    ...
    */
    ...
    /**
     * @brief Construct a new AbstractMotorGroup object.
     * @note Default constructor; default-initializes the motors std::vector.
    */
    AbstractMotorGroup(): motors() {}
    ...
    */
    template<typename... Args>
    AbstractMotorGroup(vex::motor* m1, Args ... m): AbstractMotorGroup() {
        add_motor(m1, m...);
    }
